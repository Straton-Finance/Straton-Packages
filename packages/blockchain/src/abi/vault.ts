// AUTO-GENERATED from `forge inspect Vault abi` (Straton-Contracts@v0.1.0-stf).
// DO NOT EDIT BY HAND — regenerate when the Vault contract changes.
// See Straton-COG/decisions/2026-05-16-abi-regen-strategy.md
// NOTE: contains overloaded functions (stablecoinToReceipt, receiptToStablecoin) —
// viem resolves overloads by args at call time; pass full arg tuples.
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct IVault.WithdrawRequest",
        components: [
          {
            name: "id",
            type: "uint256",
