...
- 5927243: strETF — schema + ABI no package (destrava a superfície `/stretf` do FE)
...
- 8082656: USDT canônico único por chain (drop USDC + USDT duplicado)
